    ...
    <?php include ("../include/sidebar-admin.php"); ?>
        <div class="posts col-9">
            ...
            <div class="row title-table">
                ...
                <div class="title col-3">Логин</div>
                <div class="title col-3">Почта</div>
                <div class="author col-1">Админ</div>
            ...
            ?>
                <div class="row title-table">
                    ...
                    <div class="admin col-1"><?=$user['admin'];?></div>
                    <div class="red col-2"><a href="edit.php?edit_id=<?=$user['id'];?>">Редактировать</a></div>
